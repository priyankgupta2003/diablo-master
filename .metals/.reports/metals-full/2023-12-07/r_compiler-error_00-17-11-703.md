...
### file%3A%2F%2F%2Fhome%2Fpxg9364%2FDiablo_2%2Fdiablo-master%2Ftests%2Fmult-add.scala:14: error: illegal start of simple pattern
    val  = q("""
         ^
...
object mult_add {
  def main ( args: Array[String] ) {
    ...
    val  = q("""
        var M = (tensor*(1000,1000)[ ((i,j),i*10) | i <- 0..10, j <- 0..10]);
        var N = (tensor*(1000,1000)[ ((i,j),i*10+j) | i <- 0..10, j <- 0..10]);
